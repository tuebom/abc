...
var app  = new Framework7({
  ...
  id: 'io.framework7.abc', // App bundle ID
  name: 'ABC', // App name
...
$$('#my-login-screen .login-button').on('click', function () {
  ...
  // http://212.24.111.23/
  app.request.post('http://212.24.111.23/abc/auth/login', formData, function (res) {
...
$$('#transfer-bonus .btnTransfer').on('click', function(e){
  ...
  app.request.post('http://212.24.111.23/abc/member/trfbonus', formData, function (res) {
